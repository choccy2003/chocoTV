...
const VideoCard = (props) => {
    ...
    return (
        <>
            <div onClick={() => {
                navigate(`/video/${props.data.videoId ? props.data.videoId : props.data._id}`);
                window.scrollTo(0, 0)
            }} style={{
                marginTop: "10px", cursor: "pointer", minWidth: "300px"
            }}>
                <div>
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    <div style={{ width: "35px", backgroundColor: "white", height: "35px", borderRadius: "50%", margin: "2% 1%", minWidth: "35px", backgroundImage: "url(http://localhost:3001/images/a.jpg)", backgroundSize: "contain" }}></div>
