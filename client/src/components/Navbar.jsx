...
const Navbar = () => {
  return (
   <div style={{position:"fixed",top:"0",display:"flex",padding:"0% 2%",gap:"1%",fontFamily:"Righteous",fontSize:"20px",zIndex:"100",backgroundColor:"#0d0d0f",width:"100vw"}}><div style={{width:"40px",height:"50px"}}><img style={{position:"relative",top:"6px"}} height={"40px"} src={tvlogo}></img>
